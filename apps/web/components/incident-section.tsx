...
export function IncidentSection() {
  return (
    <section className="mt-32 relative z-10 container mx-auto px-4 sm:px-6">
      ...
      {/* --- REFACTORED HEADER --- */}
      <SectionHeader 
        title={<>A lot more than uptime monitoring. <br className="hidden md:block" /> Batteries included.</>}
        description="Get all the debug data you need and collaborate with your colleagues on fixing the root cause of the incident."
        ctaText="Explore incident management"
        ctaHref="#"
      />
        ...
        <div className="flex-1 flex flex-col gap-6 mt-12 md:mt-0">
          ...
          <FadeIn delay={0.2} className="relative mt-4 pl-9 pr-5 py-6 card-premium">
            ...
            <div className="relative z-10 mt-52">
              <h4 className="text-white font-medium text-lg">Flexible incident escalations</h4>
          ...
          <FadeIn delay={0.3} className="relative mt-2 px-9 py-6 card-premium">
            ...
            <div className="relative z-10 mt-[50%]">
              <h4 className="text-white font-medium text-lg">Unlimited voice call alerts</h4>
              <p className="mt-2 text-[#9CA3AF] text-sm leading-relaxed">
