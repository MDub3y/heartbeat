            ...
            <table className="w-full text-sm text-left">
                ...
                <tbody className="divide-y divide-[#2f3647] text-[#C9D3EE]">
                    {["Today", "Last 7 days", "Last 30 days"].map((period) => (
                        <tr key={period} className="hover:bg-[#1F212E] transition-colors">
                            <td className="px-5 py-3">{period}</td>
                            <td className="px-5 py-3 text-right font-medium text-green-400">100.00%</td>
                            <td className="px-5 py-3 text-right text-[#9CA3AF]">None</td>
